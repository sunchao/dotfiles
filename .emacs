...
;;; Last Modified: Sun Mar  6 12:17:51 2022.
...
(defvar flycheck-pos-tip-timeout 9999) ;; set timeout to a large enough value.

;; color theme
(load-theme 'gruvbox t)

;; set font
(set-face-attribute 'default t :font "Iosevka" :height 140)
...
(global-set-key (kbd "C-x a i") 'indent-region)
...
(custom-set-faces
 ...
 '(magit-blame-hash ((t (:foreground "#bc6ec5" :background nil))) t)
 '(magit-blame-heading ((t (:foreground "#67b11d" :background nil))))
 '(magit-blame-name ((t (:foreground "#b1951d" :background nil))) t)
 '(magit-blame-summary ((t (:foreground "#b1951d" :background nil))) t)
 ...
 '(magit-diff-hunk-heading ((t (:foreground "#9a9aba" :background nil))))
 '(magit-diff-hunk-heading-highlight ((t (:foreground "#9a9aba" :background nil))))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(buffer-move markdown-mode dockerfile-mode yaml-mode yaml winum counsel helm sublime-themes find-file-in-repository swiper sql-indent rg racer minimap magit irony iedit go-guru go-eldoc go-autocomplete ggtags flycheck-rust find-file-in-project fill-column-indicator exec-path-from-shell elpy cyberpunk-theme concurrent)))
